...
class WindowsBot{
    ...
    */
    static registerMain(windowsMain, ip, port, driverFolder = "../"){
        ...
        server.on('connection', (clientSocket) => {
            ...
            windowsMain(new WindowsBot(clientSocket, server));
        });
    }
    ...
    */
    async getElements(hwnd, rectFilter = null, ocrServerIp = null){
    ...
    */
    async convertToRelativeXPath(hwnd, absoluteXPath){
        let strData = this.setSendData("convertToRelativeXPath", hwnd, absoluteXPath);
        let byteRet = await this.sendData(strData);
        let strRet = byteRet.toString();
        return strRet;
    }
